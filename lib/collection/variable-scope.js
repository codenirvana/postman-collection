...
_.inherit((
    ...
    VariableScope = function PostmanVariableScope (definition, layers, options) {
        ...
        if (isTrackingEnabled || preExistingChanges) {
            this.enableTracking(_.assign({}, preExistingChanges, options && options.trackingOptions));
        }
    }), Property);
...
_.assign(VariableScope.prototype, /** @lends VariableScope.prototype */ {
    ...
    set: function (key, value, type) {
        ...
        this._postman_enableTracking && this.mutations.track(MUTATIONS.SET, update);
    },
    ...
    unset: function (key) {
        ...
        this._postman_enableTracking && this.mutations.track(MUTATIONS.UNSET, { key: key });
    },
    ...
    enableTracking: function (preFill) {
        if (this._postman_enableTracking) {
            return;
        }
        ...
        this.mutations = new MutationTracker(preFill); // wipe existing changes
    },
